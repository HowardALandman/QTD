...
Curiously, despite commenting that
...
This is unfortunate, because the same degree of dilation produced by the 5 GT field
(which is many orders of magnitude beyond what can be generated in labs today)
can also be achieved by changing the potential of the muon by a kV or so
...
Duda himself, like van Holten, seems to think that strong fields (and not just potentials) are required, saying e.g. "Such experiment would need extremely strong electromagnetic field - like very near particles or near pulsars".(\cite{Duda2010} 8 Jan 2010)
...
However, other forces should also cause similar time dilation.
...
\bibitem{Swartz2003}
C. Swartz,
{\em Back-Of-The-Enveleope Physics}, p. 78
(2003)
...
{\em Proc. Phys. Soc.} B62: 8Ð21 (1949). doi:10.1088/0370-1301/62/1/303
