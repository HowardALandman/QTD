...
\date{v4.4\ \today} % delete this line to display the current date
...
While this notion has been widely rejected, a handful of theories explicitly predict such an effect.\cite{Apsel1978,Apsel1979,Apsel1981,Rodrigues1983,Ryff1985,Beil1987,vanHolten1991,vanHolten1993}
...
and only a handful of subsequent papers\cite{Rodrigues1983,Ryff1985,Beil1987,vanHolten1991,vanHolten1993,Dubey2015,Ogonowski2012} mention anything similar.
...
Thus, ignoring magnetic (and gravitomagnetic) terms, we get a unified time dilation equation
...
This makes EM time dilation locally observable, except to the muon itself.
...
Therefore, the CPT theorem only \textit{really} proves that a particle's mass and lifetime at 4-potential \textit{\textbf{A}} must equal its antiparticle's mass and lifetime at 4-potential -\textit{\textbf{A}}.
...
Correspondence and requests for materials should be addressed to howardandrewlandman@gmail.com
...
\textit{Unified Field Theories in the First Third of the 20th Century},
(Birkh\"{a}user Verlag, 1994).

\bibitem{Weyl1923}
Weyl, H.,
\textit{Raum$\cdot$Zeit$\cdot$Materie} 6th ed.,
...
\textit{Zeitschrift f\"{u}r Physik A.} \textbf{37} 895-906 (1926).
%doi:10.1007/BF01397481.

\bibitem{Apsel1978}
Apsel, D.,
``Gravitational, electromagnetic, and nuclear theory.'',
\textit{Int. J.  of Theoretical Physics} \textbf{17} 643-649 (1978).
%DOI: 	10.1007/BF00673015

\bibitem{Apsel1979}
Apsel, D.,
``Gravitation and electromagnetism.'',
\textit{General Relativity and Gravitation} \textbf{10} 297-306 (1979).
%DOI: 10.1007/BF00759487

\bibitem{Apsel1981}
Apsel, D.,
``Time dilations in bound muon decay.'',
\textit{General Relativity and Gravitation} \textbf{13} 605-607 (1981).
%DOI: 10.1007/BF00757247

\bibitem{Rodrigues1983}
Rodrigues Jr., W.A.,
``The Standard of Length in the Theory of Relativity and Ehrenfest Paradox.'',
\textit{Il Nuovo Cimento} \textbf{74 B} 199-211 (1983).

\bibitem{Ryff1985}
Ryff, L.C.B.,
``The Lifetime of an Elementary Particle in a Field.'',
\textit{General Relativity and Gravitation} \textbf{17} 515-519 (1985).

\bibitem{Beil1987}
Beil, R.G.,
``Electrodynamics from a Metric.'',
\textit{Int. J. of Theoretical Physics} \textbf{26} 189-197 (1987).
...
Preprint at arXiv:1503.03833v5 (2015).
...
\textit{Phys. Zeitschrift} \textbf{15} 1189-1193 (1912),
...
\textit{Proc. Phys. Soc.} \textbf{B62} 8-21 (1949).
%DOI: 10.1088/0370-1301/62/1/303

\bibitem{Aharonov1959}
Aharonov, Y., Bohm, D.,
``Significance of Electromagnetic Potentials in the Quantum Theory.'',
\textit{Phys. Rev.} \textbf{115} 485-491 (1959). 
...
\bibitem{FeynmanII}
Feynman, R. P.,
\textit{Lectures on Physics} \textbf{II},
(Addison Wesley, 1964).
...
Preprint at arXiv:0704.2072v1 (2007).
...
\bibitem{Sachs1987}
Sachs, R.G.,
\textit{The Physics of Time Reversal} p.175
