...
\date{v4.0\ \today} % delete this line to display the current date
...
Weyl explicitly assumed that it doesn't\cite{Weyl1923a};
...
matter causes a time dilation field and the time dilation gradient causes gravitational acceleration.
The direction of cause and effect is completely reversed from the 1907 argument.
This line of thought was anticipated by several early unified theories,
although they tended to describe it as a speed-of-light field rather than a time dilation field.
For example, Ishiwara stated that
...
or more precisely the dilation is a function of the charge/mass ration $q/m$.
...
Van Holten thought that $5 \times 10^9\ \textup{T}$  might suffice
