...
\[ T_d \approx 1 + \frac{mgh}{mc^2} = 1 + \frac{\Delta E}{E} = \frac{E + \Delta E}{E} = \frac{E_f}{E_s} \]
Thus we have that
\[  \frac{t_f}{t_s} \approx \frac{E_f}{E_s} \]
...
In particular, the energy of an $e^-$ should go to zero if it is in a potential of +511 kV ($m_ec^2/q_e$).
...
If PTMS shows no difference at different voltages, that would establish a constant charge/mass ratio (but not, by itself, constant mass!),
and we would need to consider charge scaling.
To detect or eliminate the possibility that electron charge scales with potential, it should be sufficient to carry out "Millikan oil drop" style experiments \cite{Millikan1910,Millikan1913,wiki_oil} inside Faraday cages at various voltages.
Assuming constant charge/mass ratio, it would take a potential of about 5 kV to get a 1\% change in electron charge.

A combination of no difference in PTMS-determined charge/mass ratio at sufficiently different voltages,
and no difference in electron charge from oil drop experiments at sufficiently different voltages,
...
There are many other possibilities, including nuclear forces, but these few should suffice to demonstrate that quantum time dilation makes different predictions than the standard phase shift view, and that the differences are accessible to experimental test.
